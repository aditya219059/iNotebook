...
const Notes = (props) => {
    ...
    useEffect(() => {
        if(localStorage.getItem('token')) {
            ...
            navigate('/login');
            props.salert("Please login first", "danger");
        }
    ...
    const handleClick = (e) => {
        ...
        props.salert("Updated Successfully", "success");
    }
    const onChange = (e) => {
    ...
    return (
        <>
            ...
            <div className="row">
                ...
                {notes.map((note) => {
                    return <Noteitem key={note._id} updateNote={updateNote} note={note} salert={props.salert}/>
                })}
            </div>
        </>
    )
